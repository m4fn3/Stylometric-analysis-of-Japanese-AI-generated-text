        ...
        with open(base_path / f"data/preprocessed/wiki40b-ja/parts/wiki40b-ja_{split}.json", "r", encoding="utf-8") as f:
            ...
            for i, task in enumerate(asyncio.as_completed(tasks)):
                ...
                if i % 100 == 0:
                    ...
                    with open(base_path / f"data/preprocessed/chatgpt4o/raw/chatgpt4o_{split}_partial.json", "w", encoding="utf-8") as f:
                        json.dump(data, f, ensure_ascii=False, indent=2)
        with open(base_path / f"data/preprocessed/chatgpt4o/raw/chatgpt4o_{split}.json", "w", encoding="utf-8") as f:
            json.dump(data, f, ensure_ascii=False, indent=2)
        os.remove(base_path / f"data/preprocessed/chatgpt4o/raw/chatgpt4o_{split}_partial.json")
